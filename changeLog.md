...
##  3/17/26 - 
fixed stocks some current proie and cloe price weird values.

bot.py
adding master trade log.

HYPE spot trade. NOt perps trade. now corrected.
Also take live price and not 4h close price when we buy or sell.
