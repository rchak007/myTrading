...
def scan_ticker(
    ...
    # Calculate 45° trend scores — all 4 windows at once
    try:
        ...
        score_data = {"Score_30": 0, "Score_60": 0, "Score_90": 0, "Score_120": 0, "Score_Weighted": 0}
        earnings_alert = ""
    ...
    return {
        ...
        "Score_60":             int(score_data.get("Score_60",  0)),
        ...
        "Slope_main":           score_data.get("slope_main", np.nan),
        "R2_main":              score_data.get("r2_main",    np.nan),
        "Slope60":              score_data.get("slope60",    np.nan),
        "R2_60":                score_data.get("r2_60",      np.nan),
